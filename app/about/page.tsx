...
export const metadata: Metadata = {
  title: "About Us | Teach Niche",
  description: "Learn about Teach Niche, the premier platform for kendama instruction",
}
          ...
          <section className="my-12">
            ...
            <div className="space-y-4">
              <div className="border rounded-lg overflow-hidden">
                <div className="bg-muted p-4 font-medium">Values</div>
              ...
              <div className="border rounded-lg overflow-hidden">
                <div className="bg-muted p-4 font-medium">Why Teach Niche?</div>
                <div className="p-4">
              ...
              <div className="border rounded-lg overflow-hidden">
                <div className="bg-muted p-4 font-medium">Commission Structure</div>
                <div className="p-4 space-y-4">
              ...
              <div className="border rounded-lg overflow-hidden">
                <div className="bg-muted p-4 font-medium">Open Source Philosophy</div>
                <div className="p-4 space-y-4">
              ...
              <div className="border rounded-lg overflow-hidden">
                <div className="bg-muted p-4 font-medium">Built to Grow with the Community</div>
                <div className="p-4 space-y-4">
