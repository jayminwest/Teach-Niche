        ...
        <section className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-12">
          <div className="card bg-base-100 shadow-xl">
            <div className="card-body">
              ...
              <p className="text-lg">
                The mission of <strong>Teach Niche</strong> is to create a space
                within the kendama community for players of all skill levels to
                share knowledge, support one another, and hone their skills.
                Teach Niche places the community first and is dedicated to
                fostering growth, creating connections, and promoting more
                financial sustainability for the kendama community.
              </p>
            </div>
          </div>
          <div className="card bg-base-100 shadow-xl">
            <div className="card-body">
              ...
              Hello! I'm Jaymin West, the founder of <strong>Teach Niche</strong>. I've been passionately playing kendama for over seven years. I've been fortunate enough to sesh with players from all over the world and have tried to form Teach Niche around these shared values.
              </p>
              <p className="text-lg">
          ...
          <div className="space-y-4">
            ...
            <details className="bg-base-100 shadow-xl rounded-lg">
              ...
              <div className="p-4">
                ...
                <ul className="list-disc list-inside space-y-2">
                  <li>
                    <strong>Fairness to Creators:</strong> Creators retain 85%
                    of their earnings from each sale.
                  </li>
                  <li>
                    <strong>Platform Sustainability:</strong> The commission
                    helps cover operational costs like hosting, development, and
                    customer support, ensuring the platform remains available
                    and continuously improving.
                  </li>
                  <li>
                    <strong>Community Investment:</strong> By supporting the
                    platform, users contribute to a sustainable ecosystem that
                    benefits all members of the kendama community.
                  </li>
                </ul>
                <p className="mt-4">
            ...
            <details className="bg-base-100 shadow-xl rounded-lg">
              ...
              <div className="p-4">
                ...
                <ul className="list-disc list-inside space-y-2">
                  <li>
                    <strong>Transparency:</strong> Users can see exactly how the
                    platform works, fostering trust and accountability.
                  </li>
                  <li>
                    <strong>Collaboration:</strong> Contributions from
                    developers and enthusiasts who want to help improve Teach
                    Niche are welcome.
                  </li>
                  <li>
                    <strong>Innovation:</strong> Open sourcing encourages
                    creative solutions and rapid enhancements, benefiting the
                    entire community.
                  </li>
                </ul>
                <p className="mt-4">
            ...
            <details className="bg-base-100 shadow-xl rounded-lg">
              ...
              <div className="p-4">
                ...
                <ul className="list-disc list-inside space-y-2">
                  <li>
                    <strong>Community Feedback:</strong> Teach Niche actively
                    seeks input from users to guide platform enhancements. User
                    suggestions shape the future of Teach Niche.
                  </li>
                  <li>
                    <strong>Feature Requests:</strong> Ideas for new features or
                    improvements are welcome. Teach Niche is eager to implement
                    changes that benefit everyone.
                  </li>
                  <li>
                    <strong>Continuous Improvement:</strong> The development
                    roadmap is flexible, allowing prioritization of updates that
