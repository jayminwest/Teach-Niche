        ...
        <div className="card w-full max-w-2xl shadow-2xl bg-base-100 p-6">
          ...
          <section className="mb-8">
            ...
            <p className="text-lg">
              ...
              vehicula, erat vitae euismod efficitur, ex nunc varius lacus, sit
              amet bibendum lectus erat eget arcu.
            </p>
          </section>
          ...
          <section>
            ...
            <p className="text-lg mb-2">
              Our website uses cookies to improve your experience. This cookie
              policy explains what cookies are and how we use them.
            </p>
            <p className="text-lg mb-2">
