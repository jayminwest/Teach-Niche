        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6 lg:gap-8 xl:gap-10">
          <div className="card bg-base-200 transform-gpu transition-all duration-300 hover:-translate-y-2 hover:shadow-lg">
            <div className="card-body items-center text-center gap-4">
              ...
              <p>
                Access comprehensive tutorials from top kendama
                players.<br className="hidden xl:inline" />
                Enhance your skills with structured
                lessons.<br className="hidden xl:inline" />
          ...
          <div className="card bg-base-200 transform-gpu transition-all duration-300 hover:-translate-y-2 hover:shadow-lg">
            <div className="card-body items-center text-center gap-4">
              ...
              <p>
                Create and sell your own kendama
                lessons.<br className="hidden xl:inline" />
                Earn income by sharing your
                expertise.<br className="hidden xl:inline" />
          ...
          <div className="card bg-base-200 transform-gpu transition-all duration-300 hover:-translate-y-2 hover:shadow-lg">
            <div className="card-body items-center text-center gap-4">
              ...
              <p>
                Join a thriving community of kendama
                enthusiasts.<br className="hidden xl:inline" />
                Participate in forums and
                discussions.<br className="hidden xl:inline" />
          ...
          <div className="card bg-base-200 transform-gpu transition-all duration-300 hover:-translate-y-2 hover:shadow-lg">
            <div className="card-body items-center text-center gap-4">
              ...
              <p>
                ...
                structures.<br className="hidden xl:inline" />
                Fair policies ensuring creators are
                rewarded.<br className="hidden xl:inline" />
          ...
          <div className="card bg-base-200 transform-gpu transition-all duration-300 hover:-translate-y-2 hover:shadow-lg">
            <div className="card-body items-center text-center gap-4">
              ...
              <p>
                Building a long-term ecosystem for
                kendama.<br className="hidden xl:inline" />
                Supporting continuous growth and
                innovation.<br className="hidden xl:inline" />
          ...
          <div className="card bg-base-200 transform-gpu transition-all duration-300 hover:-translate-y-2 hover:shadow-lg">
            <div className="card-body items-center text-center gap-4">
              ...
              <p>
                Resources for personal and communal
                development.<br className="hidden xl:inline" />
                Tools to track and enhance your kendama
                journey.<br className="hidden xl:inline" />
