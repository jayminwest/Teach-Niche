    ...
    <section className="py-10 md:py-16" aria-labelledby="services-heading">
      <div className="container">
        <div className="text-center">
          <h2 id="services-heading" className="text-3xl sm:text-5xl font-bold mb-4">
            What is Teach Niche?
          </h2>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6 lg:gap-8 xl:gap-10">
          {serviceItems.map((item, index) => (
            <div key={index} className="card bg-base-200 transform-gpu transition-all duration-300 hover:-translate-y-2 hover:shadow-lg">
              <div className="card-body items-center text-center gap-4">
                <i className={`bi ${item.icon} text-4xl`} aria-hidden="true"></i>
